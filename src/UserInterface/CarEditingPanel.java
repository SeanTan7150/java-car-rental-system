 ...
 * @author user
 */
public class CarEditingPanel extends javax.swing.JPanel {

    /**
     * Creates new form CarEditingPanel
     */
    ...
    public void setCarDetail(String carId) {
        ...
        carIdInput.setText(car.getCarId());
        brandInput.setText(car.getBrand());
        modelInput.setText(car.getModel());
        colorInput.setText(car.getColor());
        manufacturingYearInput.setText(car.getManufacturingYear());
        rentalPerDayInput.setText(car.getRentalPerDay());
        lastServiceDateInput.setText(car.getLastServiceDate());
    }
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_confirmButtonActionPerformed
        ...
        Car car = new Car();
        boolean isCarUpdateSuccessful = car.update(carIdInput.getText(), input);
        if (isCarUpdateSuccessful) {
            clearInput();
            ...
            JOptionPane.showMessageDialog(currentJFrame, "The car has been edited successfully.");
        } else {
